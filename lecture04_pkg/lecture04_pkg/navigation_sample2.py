...
def main(args=None):
    ...
    waypoints = [
        ...
        # (0.197, -0.209, -1.899),  # 目的地7（X [m], Y [m], Yaw角 [rad]）
        # (-0.373, -0.298, -2.877),  # 目的地8（X [m], Y [m], yaw角 [rad]）
        # (-0.550, -0.763, -1.329),  # 目的地9（X [m], Y [m], yaw角 [rad]）
        # (-0.393, -0.967, -0.460),  # 目的地10（X [m], Y [m], yaw角 [rad]）
    ]
