...
class Listener(Node):
    ...
    ROS2 node class that subscribes to a specific topic (simple subscriber example)
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            msg_type=String, topic="chatter", callback=self.listener_callback, qos_profile=10
        )
